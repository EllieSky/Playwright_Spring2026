...
def test_has_title(page: Page):
    ...
    page.get_by_role('combobox').filter(has_text='Day').select_option(user.date_of_birth_day)
    page.get_by_role('combobox').filter(has_text='Month').select_option(user.date_of_birth_month)
    page.get_by_role('combobox').filter(has_text='Year').select_option(user.date_of_birth_year)
